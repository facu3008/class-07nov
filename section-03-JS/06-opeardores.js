...
if (ageNumber > 19) {
  console.log(`Sos mayor de 18 años. Tu edas es ${ageNumber} años`);
} else if (ageNumber < 18) {
  console.log(`sos menor de 18 años. Tu edad es ${ageNumber} años`);
} else {
  console.log(`tu edad es ${ageNumber} años`);
}
