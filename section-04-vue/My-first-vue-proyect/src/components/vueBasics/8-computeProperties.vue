    ...
    <div>
      ...
      <div class="ejercici">
        ...
        <div v-for="(myWatch, index) in myWatchList" :key="index">
            ...
            <ul>
                <li v-for="(streaming, index) in myWatch.whereToWatch" :key="index">{{streaming}}</li>
...
const myWatchList = reactive([
    {
        title: "pelicula 1",
        year: 2010,
        whereToWatch: ["Netflix", "HBO", "amazon"]
    },
    {
        title: "pelicula 2",
        year: 2005,
...
const watchOnNeflix = computed(()=>{
    return myWatchList.filter((movieInNetflix)=>{
        
        console.log(movieInNetflix.whereToWatch)
    })
})
